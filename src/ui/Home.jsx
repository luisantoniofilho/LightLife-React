...
function Home() {
  ...
  return (
    ...
    >
      ...
      {/* Main content */}
      <div className="relative z-10 p-6 text-center text-white lg:px-60">
        ...
        <button
          className="rounded-full bg-green-600 px-4 py-3 text-center text-white transition duration-300 hover:bg-green-700 md:text-2xl"
